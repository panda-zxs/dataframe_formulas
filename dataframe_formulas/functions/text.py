...
from . import (Error, XlError, replace_empty, value_return, wrap_func,
               wrap_ufunc)
...
_kw0 = {'input_parser': lambda *a: a, 'args_parser': lambda *a: map(functools.partial(replace_empty, empty=''), a)}
